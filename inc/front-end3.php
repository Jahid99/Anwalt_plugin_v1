<?php 
   ...
   $string = curl_download5($profile_link3); 
  ...
  <p class="hnpsnippet1"><?php echo $val ; ?> Bewertungen auf <a href="<?php echo $profile_link3; ?>" target="_blank">Anwalt.de</a> </p>
  <?php
   function curl_download6($Url){
   ...
   $string = curl_download6($profile_link3);
...
$output = substr($output, $start, $length);
 ...
 return $output;
  ...
  echo $string = curl_download_image_link($profile_link3);
...
$output = substr($output, $start, $length);
 ...
 return $output;
  ...
  $string = curl_download_street_address($profile_link3);
...
$output = substr($output, $start, $length);
 ...
 return $output;
  ...
  $string = curl_download_postal_code($profile_link3);
