<?php 
   ...
   $string = curl_download7($profile_link4);
   ...
   <?php 
    ...
    ?>
  <p class="hnpsnippet1"><?php echo $val ; ?> Bewertungen auf <a href="<?php echo $profile_link4; ?>" target="_blank">Anwalt.de</a> </p>
 <?php
   function curl_download8($Url){
   ...
   $string = curl_download8($profile_link4);
...
$output = substr($output, $start, $length);
 ...
 return $output;
  ...
  echo $string = curl_download_image_link($profile_link4);
...
$output = substr($output, $start, $length);
 ...
 return $output;
  ...
  $string = curl_download_street_address($profile_link4);
...
$output = substr($output, $start, $length);
 ...
 return $output;
  ...
  $string = curl_download_postal_code($profile_link4);
