<?php 
   ...
   $string = curl_download2($profile_link);
  ...
  <p class="hnpsnippet1"><?php echo $val ; ?> Bewertungen auf <a href="<?php echo $profile_link; ?>" target="_blank">Anwalt.de</a></p>
  <?php
   ...
   $string = curl_download($profile_link);
